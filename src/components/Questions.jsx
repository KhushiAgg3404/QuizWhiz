        ...
        <div className='max-w-4xl mx-auto'>
            <div className='bg-white rounded-2xl shadow-xl p-8  transition-all  duration-300 hover:shadow-2xl'>
                ...
                <div className='flex justify-between items-center'>
                    <button className='flex items-center space-x-2 px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 disabled:cursor-not-allowed transition-all duration-100 ' onClick={handlePrevious}>
                        <ArrowLeft size={20} />
                        <span>Previous</span>
                    </button>
                    {showExplanation && (
                        <button className='flex items-center space-x-2 px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 disabled:cursor-not-allowed transition-all duration-100' onClick={handleNext}>
